            ...
            <div className="container">
                ...
                <ul className="works-section__list">
                    <li className="works-section__item">
                        <img className="works-section__img" src={Wt1} alt="img" width={305} height={550}/>

                        <p className="works-section__desc">Гидравлическое оборудование</p>
                    </li>

                    <li className="works-section__item">
                        <img className="works-section__img" src={Wt2} alt="img" width={305} height={550}/>

                        <p className="works-section__desc">Пневматическое оборудование</p>
                    </li>

                    <li className="works-section__item">
                        <img className="works-section__img" src={Wt3} alt="img" width={775} height={550}/>

                        <p className="works-section__desc">Электрооборудование и запасные части</p>
                    </li>

                    <li className="works-section__item">
                        <img className="works-section__img" src={Wt5} alt="img" width={305} height={550}/>

                        <p className="works-section__desc">Электрокары, мопеды и скутеры</p>
                    </li>

                    <li className="works-section__item">
                        <img className="works-section__img" src={Wt6} alt="img" width={305} height={550}/>

                        <p className="works-section__desc">Химические продукты</p>
                    </li>

                    <li className="works-section__item">
                        <img className="works-section__img item" src={Wt4} alt="img" width={775} height={550}/>

                        <p className="works-section__desc">Насосы, электродвигатели и компрессоры</p>
                    </li>

                    <li className="works-section__item">
                        <img className="works-section__img" src={Wt7} alt="img" width={305} height={550}/>

                        <p className="works-section__desc">Автозапчасти</p>
                    </li>

                    <li className="works-section__item">
                        <img className="works-section__img" src={Wt8} alt="img" width={305} height={550}/>

                        <p className="works-section__desc">Напольные покрытия</p>
                    </li>

                    <li className="works-section__item">
                        <img className="works-section__img" src={Wt9} alt="img" width={775} height={550}/>
